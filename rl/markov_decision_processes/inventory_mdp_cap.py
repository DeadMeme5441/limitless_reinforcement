...
class InventoryMDPCap(FiniteMarkovDecisionProcess[InventoryState, int]):
    def __init__(
        self,
        capacity: int,
...
if __name__ == "__main__":
    ...
    si_mdp: FiniteMarkovDecisionProcess[InventoryState, int] = InventoryMDPCap(
    ...
    fdp: FiniteDeterministicPolicy[InventoryState, int] = FiniteDeterministicPolicy(
        {
